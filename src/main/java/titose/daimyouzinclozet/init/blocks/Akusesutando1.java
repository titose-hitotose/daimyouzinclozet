package titose.daimyouzinclozet.init.blocks;
...
import titose.daimyouzinclozet.util.CollisionHelper;


public class Akusesutando1 extends Block{

	public static final PropertyDirection FACING;

	public Akusesutando1() {
		super(Material.WEB);
		setHardness(1.5F);
		setResistance(1.0F);
		disableStats();
